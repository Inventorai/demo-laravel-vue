...
<template>
    <span
        v-if="count > 0"
        class="flex shrink-0 items-center gap-1 rounded-full bg-amber-500/15 px-2 py-0.5 text-[10px] font-medium whitespace-nowrap text-amber-700 dark:text-amber-400"
